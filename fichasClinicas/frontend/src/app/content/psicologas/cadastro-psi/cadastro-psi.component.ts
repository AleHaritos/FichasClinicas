...
@Component({
  selector: 'app-cadastro-psi',
  templateUrl: './cadastro-psi.component.html',
  styleUrls: ['./cadastro-psi.component.css']
})
export class CadastroPsiComponent implements OnInit {
